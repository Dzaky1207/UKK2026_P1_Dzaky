    ...
    <div class="pc-content">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ isset($alat) ? route('alat.update', $alat->id) : route('alat.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($alat))
                        @method('PUT')
                    @endif
                    ...
                    <div class="mb-3">
                        ...
                        @if(isset($alat) && $alat->path_foto)
                            <img src="{{ asset('storage/' . $alat->path_foto) }}" class="img-fluid mt-2" style="max-height:100px;" alt="Foto Alat">
                        @endif
                    </div>
